...
if(args.all):
    os.system("tar -czvf file_to_send.tar.gz hgDecompose/* data/datasets/real/* data/datasets/synthetic/* data/datasets/gowalla/* data/datasets/scalability/*  HyperNetX/* *.py *sh *md")
else:
